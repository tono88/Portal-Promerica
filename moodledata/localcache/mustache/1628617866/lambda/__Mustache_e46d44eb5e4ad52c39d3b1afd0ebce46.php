...
class __Mustache_e46d44eb5e4ad52c39d3b1afd0ebce46 extends Mustache_Template
{
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '    class="message-drawer bg-light hidden"
';
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="drawer-top p-2 border-bottom bg-secondary text-right">
';
...
';
        ...
        $buffer .= $this->sectionEbb147fabaaf7c66cb4a363c1d675d50($context, $indent, $value);
    ...
    private function sectionEbb147fabaaf7c66cb4a363c1d675d50(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
