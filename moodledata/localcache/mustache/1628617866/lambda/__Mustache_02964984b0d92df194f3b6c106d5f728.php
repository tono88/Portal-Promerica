...
class __Mustache_02964984b0d92df194f3b6c106d5f728 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="input-prepend d-flex flex-grow m-0">
';
        $buffer .= $indent . '            <span class="add-on bg-white pr-0">
';
        $buffer .= $indent . '                ';
        // 'pix' section
...
';
        $buffer .= $indent . '                class="form-control border-left-0 searchinput"
';
