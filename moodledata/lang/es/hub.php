...
/**
 * Strings for component 'hub', language 'es', branch 'MOODLE_37_STABLE'
 *
 * @package   hub
...
$string['enablecoursepublishing'] = 'Compartir curso en Moodle.net';
$string['enablecoursepublishing_help'] = 'Moodle.net es nuestro sitio comunitario para compartir cursos y contenidos con otros usuarios Moodle del mundo. Un curso puede ser compartido para que otros se inscriban en él (requiere auto-registro basado en E-mail en el sitio y auto-matrícula en el curso) o como un archivo de respaldo para que otros lo descarguen.';
